...
public class BakeryController {
    ...
    public HttpResponseDto getBakeryList() {
        HttpResponseDto httpResponseDto = new HttpResponseDto();
        List<Bakery> bakery = bakeryService.getBakeryList();
        httpResponseDto.setHttpStatus(HttpStatus.OK);
        httpResponseDto.setResponseData(bakery);
        return httpResponseDto;
    }
    ...
    public HttpResponseDto createBakery(@RequestBody Bakery bakery) {
        HttpResponseDto httpResponseDto = new HttpResponseDto();
        Bakery newBakery = bakeryService.createBakery(bakery);
